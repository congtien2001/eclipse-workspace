...
<body style="text-align: center; background: #ccc;">
	<form action="ktdnController" method="post" style="width: 500px; text-align: initial; display: inline-block;">
  <div class="container">
  ...
  <div class="container signin">
    <p>Already have an account? <a href="dangnhapController">Sign in</a>.</p>
  </div>
</form>
</body>
</html>