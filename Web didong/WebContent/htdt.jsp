...
<!-- Search Nav -->
<div class="topnav">
  <a class="active" href="didongController">Trang chủ</a>
...
<%if(n==0){ %> <p style="margin: 20px 0 0 20px;"><b>Không tìm thấy di động nào!</b></p> <%} 
	else { %>
...
<div style="padding-left:16px; display: flex; justify-content: center; margin: 40px;">
	<table class="table table-hover">
		<tr>
		  ...
		  %>
		  		<tr>
			  		<td><img src="<%=dd.getAnh() %>"></td>
			  		<td><p><%=dd.getMadidong() %></p></td>
			  		<td><p><%=dd.getTendidong() %></p></td>
			  		<td><p><%=dd.getSoluong() %></p></td>
			  		<td><p><%=dd.getGia() %></p></td>
			  		<td><p><%=dd.getGia()*dd.soluong %></p></td>
			  		<td><p><%if(dd.getGia()*dd.soluong >20000000) out.print("Cao"); else out.print("Trung bình"); %></p></td>
		  		</tr>
